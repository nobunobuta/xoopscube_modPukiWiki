...
class MyTextSanitizer
{
	...
	*/
	 ...
	 * @return  string
	 **/
	function &xoopsCodeDecode(&$text, $allowimage = 1, $ml_only=0)
	{
		$patterns = array();
		$replacements = array();
...
##################### Deprecated Methods ######################
	...
	function makeTboxData4Show($text, $smiley=0)
	{
		$text = $this->htmlSpecialChars($text);
		// MT hack added by hsalazar //
		$text =& $this->xoopsCodeDecode($text, 0, 1);
		// MT hack added by hsalazar //
		return $text;
	}
